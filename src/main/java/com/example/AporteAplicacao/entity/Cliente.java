...
public class Cliente {
    ...
    public Cliente(String nomeCompleto, String cpf, LocalDate dataNascimento, String endereco, String email, String telefone, String profissao, String contaBancaria, BigDecimal rendaMensal, String perfilInvestidor, List<String> beneficiarios, Integer prazoInvestimentoDesejado) {
    ...
    public Integer getPrazoInvestimentoDesejado() {
        return prazoInvestimentoDesejado;
    }

    public void setPrazoInvestimentoDesejado(Integer prazoInvestimentoDesejado) {
        this.prazoInvestimentoDesejado = prazoInvestimentoDesejado;
    }
